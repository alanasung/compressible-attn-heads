...
from progattn.configs.loader import register_schema
...
def _load_stage_registry(package: str = "progattn") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in progattn.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from progattn.configs.loader import config_to_dict, save_resolved_config
    from progattn.models.device import get_device
    from progattn.utils.logging import configure_logging
    from progattn.utils.reproducibility import set_seed
    from progattn.utils.run_manifest import create_run_dir, save_run_metadata
